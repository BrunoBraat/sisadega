...
<body>
	...
	%>	
		<div class="container"> 
			<div class="alert alert-danger">		
				...
				<br></br><a href="cadastrarVinho.jsp" class="btn btn-default">Cadastrar Novo</a>
	...
	<div class="container">		
		<!-- Botões -->	
		<br>
		<a href="cadastrarVinho.jsp" class="btn btn-default">Cadastrar Novo</a>
		<!-- <a href="confirmacao.jsp?operacao=limparBD" class="btn btn-default">Limpar Banco de Dados</a> -->
		<br/><br/>
	        ...
	        <div class="panel panel-default filterable">
	            ...
	            <table class="table table-striped">
	                ...
	                <% for( Vinho vinho : vinhos ) { %>
				      <tr>
				      	<td>
				      		<a href="editarVinho.jsp?idVinho=<%=vinho.getIdVinho()%>" data-toggle="popover" data-trigger="hover" data-content="Editar"><img src="images/icon_lapis.png" alt="Editar" title="Editar" style="width:16px;height:16px;border:0;"></img></a>
				      		<a href="confirmacao.jsp?idVinho=<%=vinho.getIdVinho()%>&nomeVinho=<%=vinho.getNomeVinho()%>&operacao=excluirVinho" data-toggle="popover" data-trigger="hover" data-content="Excluir"><img src="images/icon_delete.png" alt="Excluir" title="Excluir" style="width:16px;height:16px;border:0;"></img></a>
				      	</td>				      	
